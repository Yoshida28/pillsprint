/*
  ...
  1. New Tables
    ...
    - `prescriptions` - User prescription management
  ...
  3. Data
    - Insert 50+ comprehensive medicine entries
    - Include emergency and regular medicines
...
-- Insert comprehensive sample medicine data with consistent columns
INSERT INTO medicines (
  name, description, composition, price, stock, category, emergency, image_url, 
  manufacturer, dosage_form, strength, package_size, requires_prescription, 
  side_effects, warnings, usage_instructions, storage_instructions
) VALUES
...
('Zinc Supplements', 'Essential mineral supplement for immune support and wound healing.', '{"Zinc Gluconate 50mg"}', 1.08, 110, 'Vitamins', false, 'https://images.pexels.com/photos/208513/pexels-photo-208513.jpeg?auto=compress&cs=tinysrgb&w=800', 'Nature Made', 'Tablet', '50mg', '30 tablets', false, '{"Nausea", "Stomach upset"}', '{"Take with food", "Do not exceed recommended dose"}', 'Take 1 tablet daily with food.', 'Store in a cool, dry place.'),

('Magnesium Tablets', 'Magnesium supplement for muscle and nerve function, bone health.', '{"Magnesium Oxide 400mg"}', 1.32, 95, 'Vitamins', false, 'https://images.pexels.com/photos/6303590/pexels-photo-6303590.jpeg?auto=compress&cs=tinysrgb&w=800', 'Nature''s Bounty', 'Tablet', '400mg', '30 tablets', false, '{"Diarrhea", "Stomach upset"}', '{"Take with food", "Start with lower dose"}', 'Take 1 tablet daily with food.', 'Store in a cool, dry place.'),

('B-Complex Vitamins', 'Complete B-vitamin complex for energy metabolism and nervous system health.', '{"B1", "B2", "B6", "B12", "Niacin", "Folic Acid"}', 1.56, 85, 'Vitamins', false, 'https://images.pexels.com/photos/3683074/pexels-photo-3683074.jpeg?auto=compress&cs=tinysrgb&w=800', 'Solgar', 'Capsule', 'Complex', '30 capsules', false, '{"Nausea", "Flushing"}', '{"Take with food", "May cause bright yellow urine"}', 'Take 1 capsule daily with breakfast.', 'Store in a cool, dry place.'),

('Biotin Supplements', 'Biotin supplement for healthy hair, skin, and nails.', '{"Biotin 5000mcg"}', 1.44, 75, 'Vitamins', false, 'https://images.pexels.com/photos/208513/pexels-photo-208513.jpeg?auto=compress&cs=tinysrgb&w=800', 'Nature''s Bounty', 'Capsule', '5000mcg', '30 capsules', false, '{"Rare: skin rash"}', '{"Take with food", "May affect lab test results"}', 'Take 1 capsule daily with food.', 'Store in a cool, dry place.'),
...
('Cranberry Supplements', 'Cranberry extract for urinary tract health and antioxidant support.', '{"Cranberry Extract 500mg"}', 1.68, 65, 'Women''s Health', false, 'https://images.pexels.com/photos/6303590/pexels-photo-6303590.jpeg?auto=compress&cs=tinysrgb&w=800', 'AZO', 'Capsule', '500mg', '30 capsules', false, '{"Stomach upset", "Diarrhea"}', '{"Take with food", "Drink plenty of water"}', 'Take 1-2 capsules daily with food.', 'Store in a cool, dry place.'),
